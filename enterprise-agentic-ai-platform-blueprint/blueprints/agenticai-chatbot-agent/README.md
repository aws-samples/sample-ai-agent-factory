...
Chatbot pattern per spec §4.1, shipped in v1 scope.

Differentiators vs `agenticai-task-agent`:

- **Human-in-the-loop escalation path**. The agent routes unresolvable queries to a human queue instead of looping.
