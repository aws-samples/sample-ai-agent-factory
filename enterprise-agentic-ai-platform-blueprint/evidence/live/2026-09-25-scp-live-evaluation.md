...
| IAM evaluator twins, final set   | **49/49** (24 deny, 25 allow) re-run on the final SCP-02 with the direct-Mantle deny (D12): the 43 twins above plus six Mantle twins — developer and Platform admin `bedrock-mantle:CreateInference` denied, a look-alike role name denied, the `AgenticAI-InferenceGateway-<env>` role and its assumed-role session allowed, AWS service principals exempt. Access Analyzer unchanged (SCP-01 … SCP-11 clean, SCP-12 the warning above)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| Unit + regression suites         | SCP unit + bypass-regression suites 66/66 (shape tests rewritten to pin the evaluator-proven bodies); full suite 58 suites / 724 tests                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
