...
MCP_SERVERS: dict[str, dict] = {
    ...
    "snowflake-cortex": {
        ...
        "oauth_descriptor": {
            "grant_type": "CLIENT_CREDENTIALS",
            "note": "OAuth 2.0 or PAT-as-Bearer; non-streaming responses",
        },
    ...
    "notion": {
        ...
        "example_tools": ["search", "fetch", "create-pages", "update-page"],
        "live_testable": False,
    },
    "atlassian": {
        "id": "atlassian",
        "display_name": "Atlassian (Jira+Confluence) MCP",
        "publisher": "Atlassian",
        "category": "Project Management",
        ...
        "example_tools": ["search", "fetch", "createJiraIssue", "createConfluencePage"],
        "live_testable": False,
    },
    "salesforce": {
        "id": "salesforce",
        ...
        "category": "CRM",
        "endpoint": "https://api.salesforce.com/platform/mcp/v1/{server}",
        "tier": "adapter-3lo",
        "verified": "docs",
        "auth_type": "oauth2_3lo",
        "credentials_needed": "Salesforce OAuth 2.0 + PKCE (per-user). Needs an adapter for headless Gateway use.",
        "example_tools": ["sobject_read", "soql_query", "describe_object", "apex_action"],
        "live_testable": False,
    },
    "hubspot": {
        "id": "hubspot",
        ...
        "example_tools": ["get_crm_object", "search_crm", "summarize_tickets", "get_engagements"],
        "live_testable": False,
    },
    "asana": {
        "id": "asana",
        ...
        "example_tools": ["create_task", "search_tasks", "list_sections", "get_project_status"],
        "live_testable": False,
    },
    "box": {
        "id": "box",
        ...
        "example_tools": ["search_files_keyword", "get_file_content", "upload_file", "ai_qa_single_file"],
        "live_testable": False,
    },
    "gitlab": {
        "id": "gitlab",
        ...
        "example_tools": ["get_project", "get_issue", "get_merge_request", "create_issue"],
        "live_testable": False,
    },
    "figma": {
        "id": "figma",
        "display_name": "Figma Dev Mode MCP",
        "publisher": "Figma",
        "category": "Design",
        ...
        "example_tools": ["get_code", "get_variable_defs", "get_image", "add_to_canvas"],
        "live_testable": False,
    },
    ...
    "brave-search": {
        ...
        "example_tools": ["brave_web_search", "brave_local_search", "brave_news_search"],
        "live_testable": False,
    },
    "perplexity": {
        "id": "perplexity",
        ...
        "example_tools": ["perplexity_search", "perplexity_ask", "perplexity_research"],
        "live_testable": False,
    },
}
