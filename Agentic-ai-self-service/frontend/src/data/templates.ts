...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    longDescription: 'A production-ready customer support agent using Strands with persistent memory, MCP Gateway for tool access, JWT auth forwarding, and OpenTelemetry observability. Includes conversation context and multi-turn support.',
    icon: '🎧',
    difficulty: 'advanced',
...
- Remember context from previous messages in the conversation`,
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    longDescription: 'Based on the official AWS blueprint: a production-ready customer support agent with Gateway tools for order lookup, customer info, and refund processing. Includes persistent memory for multi-turn conversations and automatic Cognito auth.',
    icon: '🎧',
    difficulty: 'advanced',
