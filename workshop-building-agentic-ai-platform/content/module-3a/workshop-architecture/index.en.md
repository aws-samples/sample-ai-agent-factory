...
| **Amazon Managed Service for Prometheus** | Metrics backend scraped by the ADOT sidecar |
| **Grafana OSS (self-hosted on ECS Fargate)** | Observability dashboards, queries Prometheus |
